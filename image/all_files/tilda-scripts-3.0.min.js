...
function t_onFuncLoad(funcName, okFunc, time) {
    if ("function" == typeof window[funcName]) okFunc();
        ...
        setTimeout((function checkFuncExist() {
            ...
            "function" != typeof window[funcName] ? ("complete" === document.readyState && currentTime - startTime > 5e3 && "function" != typeof window[funcName] && callbackError(), setTimeout(checkFuncExist, time || 100)) : okFunc()
        }))
    }
}
...
window.browserLang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2), window.tildaBrowserLang = window.browserLang, t_onReady((function() {
    ...
    function() {
        ...
        function updateFontSize(breakpoint) {
            ...
            for (var customStyleElements = document.querySelectorAll('[data-customstyle="yes"]'), fieldElements = document.querySelectorAll("[field] span, [field] strong, [field] em"), i = 0; i < customStyleElements.length; i++) {
